define(['jquery', 'underscore', 'backbone', 'sweatshop'], function ($, _, Backbone, Sweatshop) {
    ...
    describe('Sweatshop', function () {
        ...
        describe('Sweatshop', function () {
            ...
            var ss = new Sweatshop(),
                workerUrl = '/tests/js/specs/worker.js',
                job;
            ...
            it('can queue and execute multiple jobs in the right order', function () {
